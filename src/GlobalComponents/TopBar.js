...
const LogoImage2=styled.div`
  width: 130px;
  height: 50px;
  background-image: url(${props => props.img==="#000000"?Image.LogoBlack:Image.LogoWhite}) ;
        ...
        return(
            <>
                <LogoPlace style={{justifyContent: "flex-start"}}>
                    <LogoImage2 img={Data.HomepageData[currentPage].logoColor}/>
                    <Title color={Data.HomepageData[currentPage].logoColor}>
                        \  {Data.HomepageData[currentPage].title}
                    </Title>
                </LogoPlace>
            </>
        )
