...
class Letter extends React.PureComponent{
    ...
    handleMouseMove=(e)=>{
        this.setState({
            shadowX:((e.clientX-document.body.clientWidth/2)/document.body.clientWidth*2).toFixed(2),
            shadowY:((e.clientY-document.body.clientHeight/2)/document.body.clientHeight*2).toFixed(2)
        })
    ...
    render() {
        return(
            <LetterDiv startX={this.props.startXY.x} startY={this.props.startXY.y} endX={this.props.endXY.x} endY={this.props.endXY.y} rotate={this.props.rotate} ifAnimation={this.props.ifAnimation} endScale={this.props.endScale}>
                ...
                <LetterShadow left={-(this.state.shadowX)*30} top={-(this.state.shadowY)*30}>
